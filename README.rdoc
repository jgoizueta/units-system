...
a <tt>module.clas_eval{...}</tt> block can reference module's contants without qualification.
To make this apt for Ruby 1.8 we should replace expressions such as <tt>u{W}</tt> by either
